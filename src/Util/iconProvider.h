...
class iconProvider { // Convert into namespace?
    public:
        ...
        static QIcon getLogo() {
            return getIcon(
                "huli",
                ":/res/icons/app/logo.svg"
            );
        }
        
        static QIcon getNewTabIcon() {
            return getIcon(
                "tab-new-symbolic",
                ":/res/icons/actions/plus.svg",
                { "tab-new" }
            );
        }

        static QIcon getReloadIcon() {
            return getIcon(
                "view-refresh-symbolic",
                ":/res/icons/actions/refresh.svg",
                { "view-refresh" }
            );
        }

        static QIcon getBackIcon() {
            return getIcon(
                "go-previous-symbolic",
                ":/res/icons/actions/arrow-left.svg",
                { "go-previous" }
            );
        }

        static QIcon getForwardIcon() {
            return getIcon(
                "go-next-symbolic",
                ":/res/icons/actions/arrow-right.svg",
                { "go-next" }
            );
        }
        ...
        static QIcon getSearchIcon() {
            return getIcon(
                "search-symbolic",
                ":/res/icons/actions/search.svg",
                { "search" }
            );
        }

        static QIcon getCancelIcon() {
            return getIcon(
                "dialog-cancel",
                ":/res/icons/actions/cancel.svg"
            );
        }
        ...
        static QIcon getPauseIcon() {
            return getIcon(
                "media-playback-pause-symbolic",
                ":/res/icons/actions/pause.svg",
                { "media-playback-pause" }
            );
        }

        static QIcon getPlayIcon() {
            return getIcon(
                "media-playback-start-symbolic",
                ":/res/icons/actions/play.svg",
                { "media-playback-start" }
            );
        }

        static QIcon getSecurityIcon() {
            return getIcon(
                "dialog-password",
